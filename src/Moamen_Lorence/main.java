	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		for (int i = 0; i < number; i++) {
			...
			if (choose == 1) {
				...
				System.out.println(
						"\nThe input or value provided is not recognized or accepted by the system or program as valid or appropriate, please try again with a correct input or value.");
				i--;
			}
		}
		System.out.println("\n---------------------------------------------------------------------------------");
